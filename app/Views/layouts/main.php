...
<head>
	...
	<div class="container-fluid"
		style="background-image:url(https://yt3.googleusercontent.com/qd_fOR_7fiOlxePKpWniaJSMla9Bv1jRV0wxufCxhVWHJ657Bzmh3yaK1PTi9BydS-2wTnlGCg=w1707-fcrop64=1,00005a57ffffa5a8-k-c0xffffffff-no-nd-rj); height: 150px; background-size: 100%;">
		<div class="row align-items-center py-2 px-lg-5">
			<div class="col-lg-4">
				<a href="index" class="navbar-brand d-none d-lg-block">
					<h1 class="m-0 display-5 text-uppercase"
						style="background-image:url(https://yt3.googleusercontent.com/ytc/AOPolaRg29yzgWrtwjpAOuKvr3BM6NQxExpGUqMixyYGbQ=s176-c-k-c0x00ffffff-no-rj);">
					</h1>
				</a>
			</div>
		</div>
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu vl-bg-c" aria-labelledby="dropdown07">
										<?php if (isset($_SESSION) && in_array('1', $_SESSION['colaboradores']['permissoes'])): ?>
											<a href="<?= site_url('colaboradores/pautas/cadastrar'); ?>"
												class="dropdown-item">Sugerir Pauta</a>
										<?php endif; ?>
										<?php if (isset($_SESSION) && in_array('1', $_SESSION['colaboradores']['permissoes'])): ?>
									...
									<div class="dropdown-menu vl-bg-c" aria-labelledby="dropdown07">
										<?php if (isset($_SESSION) && in_array('2', $_SESSION['colaboradores']['permissoes'])): ?>
											<a href="<?= site_url('colaboradores/artigos/cadastrar'); ?>"
												class="dropdown-item">Escrever Artigo</a>
										<?php endif; ?>
										<?php if (isset($_SESSION) && in_array('2', $_SESSION['colaboradores']['permissoes'])): ?>
	...
	<div class="container-fluid bg-light pt-5 px-sm-3 px-md-5 vl-bg-c">
		<div class="row">
			<div class="col-lg-4 col-md-6 mb-5">
				<h4 class="font-weight-bold mb-4"><img class="img-thumbnail rounded-circle mr-3" width="100px"
						src="https://yt3.googleusercontent.com/ytc/AOPolaRg29yzgWrtwjpAOuKvr3BM6NQxExpGUqMixyYGbQ=s176-c-k-c0x00ffffff-no-rj" />Visão
					Libertária</h4>
				<div class="d-flex flex-wrap m-n1 justify-content-start">
					<p>Visão Libertária é um jornal diário no YouTube, parte do canal ancap.su com conteúdo voltado ao
						libertarianismo. Trata-se de um jornal colaborativo em que muita gente participa da criação,
						edição, escolha dos temas e consegue receber algumas migalhas que o YouTube, de vez em quando,
						joga pra gente.</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 mb-5 text-center">
				...
				<div class="d-flex justify-content-center mt-4">
					<a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 60px; height: 60px;"
						href="#">
