									...
									<div>
										<a class="link-white me-3 text-reset" href="<?= site_url('colaboradores/perfil/notificacoes'); ?>" id="navbarDropdownMenuLink"
											...
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
												...
												<?php if(!isset($contador_notificacao) || $contador_notificacao == 0): ?>
													<path
											...
											<span class="badge badge-pill badge-danger"
												style="float:right;margin-bottom:-10px;"><?= (!isset($contador_notificacao) || $contador_notificacao == 0)?('0'):($contador_notificacao); ?></span>
										</a>
									</div>
								</li>
							</ul>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 mb-5">
				...
				<div class="d-flex flex-wrap m-n1 justify-content-start">
					<p>
						<?= $_SESSION['site_config']['texto_rodape']; ?>
					</p>
				</div>
			</div>
					...
					<div class="d-flex justify-content-center mt-4">
						<?php if ($_SESSION['site_config']['twitter'] !== NULL): ?>
							<a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 60px; height: 60px;"
								href="<?= $_SESSION['site_config']['twitter']; ?>" target="_blank">
						...
						<?php if ($_SESSION['site_config']['instagram'] !== NULL): ?>
							<a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 60px; height: 60px;"
								href="<?= $_SESSION['site_config']['instagram']; ?>" target="_blank">
								<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
						...
						<?php if ($_SESSION['site_config']['youtube'] !== NULL): ?>
							<a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 60px; height: 60px;"
								href="<?= $_SESSION['site_config']['youtube']; ?>" target="_blank">
								<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
			...
			<div class="col-lg-4 col-md-6 mb-5">
				...
				<div class="d-flex flex-column justify-content-start">
					<a class="mb-2" href="<?= site_url('site/contato'); ?>"><i
							class="fa fa-angle-right text-dark mr-2"></i>Entre em
						contato</a>
