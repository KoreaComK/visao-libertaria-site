...
<div class="container-fluid py-3">
	<div class="container">
		<div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<?php if (isset($artigo['link_shorts']) && $artigo['link_shorts'] !== null) : ?>
				<p><a href="<?= $artigo['link_shorts']; ?>" target="_blank">Ir para o vídeo do Shorts.</a></p>
			<?php endif; ?>
		</div>
		...
		<?php if ($fase_producao == '5') : ?>
			<div class="d-block mb-5 text-left">
				<form class="needs-validation w-100" id="form-publicacao" novalidate="yes" method="post">
					...
					<div class="mb-3 div-descricao collapse" style="height: 50px;">
						<div class="input-group">
