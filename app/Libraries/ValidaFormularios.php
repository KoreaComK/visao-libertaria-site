...
class ValidaFormularios extends BaseController
{
	...
	public function validaFormularioCadastroColaborador($post)
	{
		...
		$validation->setRules([
			'apelido' => [
				'label' => 'Apelido',
				'rules' => 'required|max_length[255]|string|is_unique[colaboradores.apelido]|min_length[6]',
				'errors' => [
	...
	public function validaFormularioPerfilColaborador($post, $id)
	{
		...
		$validation->setRules([
			'apelido' => [
				...
				'rules' => 'required|max_length[255]|is_unique[colaboradores.apelido,id,' . $id . ']',
				'errors' => [
	...
	public function validaFormularioArtigoNarracaoFile()
	{
		...
		$validation->setRules([
			'audio' => [
				...
				'rules' => 'uploaded[audio]|ext_in[audio,mp3]|max_size[audio,25600]',
				'errors' => [
					'uploaded' => 'O campo {field} é obrigatório e não pode ser maior que 25MB',
					'ext_in' => 'Arquivo de áudio aceito apenas em .mp3',
					'max_size' => 'Tamanho do arquivo de áudio deve ser menor que 25MB.',
				],
			],
		]);
		$validation->run();
